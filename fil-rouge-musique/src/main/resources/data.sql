...
insert into appuser (id,nickname,isAdmin) values (appuser_seq_id.nextval, "Andrea", true);
insert into appuser (id,nickname,isAdmin) values (appuser_seq_id.nextval, "Franck", true);
insert into appuser (id,nickname,isAdmin) values (appuser_seq_id.nextval, "Yves", true);
insert into appuser (id,nickname,isAdmin) values (appuser_seq_id.nextval, "Jules", false);
insert into appuser (id,nickname,isAdmin) values (appuser_seq_id.nextval, "Bernard", false);
insert into appuser (id,nickname,isAdmin) values (appuser_seq_id.nextval, "Vincent", false);
insert into appuser (id,nickname,isAdmin) values (appuser_seq_id.nextval, "Jean Marc", false);
insert into appuser (id,nickname,isAdmin) values (appuser_seq_id.nextval, "Pierre", false);
insert into appuser (id,nickname,isAdmin) values (appuser_seq_id.nextval, "Carole", false);
insert into appuser (id,nickname,isAdmin) values (appuser_seq_id.nextval, "Philippe", false);
insert into appuser (id,nickname,isAdmin) values (appuser_seq_id.nextval, "Fred", false);
insert into appuser (id,nickname,isAdmin) values (appuser_seq_id.nextval, "Benoit", false);
insert into appuser (id,nickname,isAdmin) values (appuser_seq_id.nextval, "Saya", false);
insert into appuser (id,nickname,isAdmin) values (appuser_seq_id.nextval, "Sylvain", false);
insert into appuser (id,nickname,isAdmin) values (appuser_seq_id.nextval, "Franck", false);
insert into appuser (id,nickname,isAdmin) values (appuser_seq_id.nextval, "Guillaume", false);
insert into appuser (id,nickname,isAdmin) values (appuser_seq_id.nextval, "Nicolas", false);
